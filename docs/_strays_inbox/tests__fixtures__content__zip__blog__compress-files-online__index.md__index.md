...
```csharp
string sourceFilePath = "alice29.txt";
string zipFilePath = "compressed_file.zip";

if (File.Exists(sourceFilePath))
{
    using (FileStream zipFile = File.Open(zipFilePath, FileMode.Create))
    {
        using (FileStream source1 = File.Open(sourceFilePath, FileMode.Open, FileAccess.Read))
        {
