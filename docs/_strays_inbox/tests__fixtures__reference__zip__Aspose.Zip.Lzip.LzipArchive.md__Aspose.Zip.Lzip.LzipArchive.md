---
linkTitle: "Class LzipArchive"
title: "Class LzipArchive"
description: "This class represents a Lzip archive file. Use it to compose or extract Lzip archives."
summary: "This class represents a Lzip archive file. Use it to compose or extract Lzip archives."
categories:
  - Class
...
[LzipArchive](/zip/aspose.zip.lzip.lziparchive)
...
### <a id="Aspose_Zip_Lzip_LzipArchive__ctor_Aspose_Zip_Lzip_LzipArchiveSettings_"></a> LzipArchive\(LzipArchiveSettings\)
...
`settings` [LzipArchiveSettings](/zip/aspose.zip.lzip.lziparchivesettings)

Setting of particular lzip archive with definition of dictionary size.

### <a id="Aspose_Zip_Lzip_LzipArchive__ctor_System_IO_Stream_Aspose_Zip_Lzip_LzipLoadOptions_"></a> LzipArchive\(Stream, LzipLoadOptions\)
...
`options` [LzipLoadOptions](/zip/aspose.zip.lzip.lziploadoptions)
...
### <a id="Aspose_Zip_Lzip_LzipArchive__ctor_System_String_Aspose_Zip_Lzip_LzipLoadOptions_"></a> LzipArchive\(string, LzipLoadOptions\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Settings"></a> Settings
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Dispose"></a> Dispose\(\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Dispose_System_Boolean_"></a> Dispose\(bool\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Extract_System_IO_Stream_"></a> Extract\(Stream\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Extract_System_IO_FileInfo_"></a> Extract\(FileInfo\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Extract_System_String_"></a> Extract\(string\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_ExtractToDirectory_System_String_"></a> ExtractToDirectory\(string\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Save_System_IO_Stream_"></a> Save\(Stream\)
...
<p>
  <code class="paramref">outputStream</code> must be seekable.</p>
...
<code class="paramref">outputStream</code> does not support seeking.

 [ArgumentNullException](https://learn.microsoft.com/dotnet/api/system.argumentnullexception)

<code class="paramref">outputStream</code> is null.

### <a id="Aspose_Zip_Lzip_LzipArchive_Save_System_String_"></a> Save\(string\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_Save_System_IO_FileInfo_"></a> Save\(FileInfo\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_SetSource_System_IO_Stream_"></a> SetSource\(Stream\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_SetSource_System_IO_FileInfo_"></a> SetSource\(FileInfo\)
...
### <a id="Aspose_Zip_Lzip_LzipArchive_SetSource_System_String_"></a> SetSource\(string\)
