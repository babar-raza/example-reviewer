...
Usage:
    # Monitor latest run
    python scripts/monitor_llm_telemetry.py

    # Monitor specific run
    python scripts/monitor_llm_telemetry.py --run-id 41d1b814d248066b

    # Show cost estimates
    python scripts/monitor_llm_telemetry.py --show-costs

    # Compare runs
    python scripts/monitor_llm_telemetry.py --compare run1_id run2_id
"""
