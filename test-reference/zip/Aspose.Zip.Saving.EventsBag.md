...
Events container used on Aspose.Zip.Archive saving.
...
### <a id="Aspose_Zip_Saving_EventsBag__ctor"></a> EventsBag\(\)

```csharp
public EventsBag()
```

### <a id="Aspose_Zip_Saving_EventsBag_EntryAccessed"></a> EntryAccessed
...
### <a id="Aspose_Zip_Saving_EventsBag_EntryCompressed"></a> EntryCompressed
...
#### Event Type
 ...
 [EventHandler](https://learn.microsoft.com/dotnet/api/system.eventhandler\-1)<[CancelEntryEventArgs](/zip/aspose.zip.cancelentryeventargs)\>
